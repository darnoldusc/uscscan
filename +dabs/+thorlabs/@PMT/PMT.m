classdef PMT < dabs.thorlabs.private.ThorDevice
    ...
    properties (Dependent)
        bidiPhaseAlignmentCoarse; %Value from 0-254, pertaining to current fieldSize value, allowing bidi scan adjustment ('TWO_WAY_SCAN' mode).
    end
...
%                 case 'scanZoomPos'
%                     if(obj.fieldSizeInfo.paramAvailable)
...
%            obj.paramChangeFlag = true;
    ...
    methods
        function val = get.bidiPhaseAlignmentCoarse(obj)
            zone = obj.fieldSizeInfo.paramMax - obj.scanZoomPos + 1;
        ...
        function val = get.fieldSizeInfo(obj)
            if isempty((obj.scanZoomPos))
                val = 0;
            else
                val = obj.paramInfoMap('scanZoomPos');
            end
        end   
...
%         function scanZoomPosAvailable = GetscanZoomPos(obj)
%             pramInfo = obj.paramInfoMap('scanZoomPos');
%             scanZoomPosAvailable= pramInfo.paramAvailable;
%         end
